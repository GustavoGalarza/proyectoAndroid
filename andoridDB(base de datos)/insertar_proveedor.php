...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($rut !== null && $nombre !== null) {
        ...
        $consulta = "INSERT INTO proveedores (rut, nombre, direccion_calle, direccion_numero, direccion_comuna, direccion_ciudad, telefono, pagina_web) 
                     VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conexion->prepare($consulta);

        $stmt->bind_param("ssssssss", $rut, $nombre, $direccion_calle, $direccion_numero, $direccion_comuna, $direccion_ciudad, $telefono, $pagina_web);
